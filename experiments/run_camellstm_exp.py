...
def run_normal_dl(
    ...
    args = cmd(
        ...
        scaler_params={"prcp_norm_cols": ["streamflow"],
        ...
        model_loader={
            "load_way": "best","test_epoch":"best_model.pth",
        },
        calc_metrics=True,
        opt_param={
            "lr": 0.0005,
        },
        lr_scheduler={1: 0.0001, 2: 0.00001, 3: 0.00005},
...
run_normal_dl(os.path.join("ndl", "expkratzertfinal"), "D:/torchhydro/data/basin_531.csv")